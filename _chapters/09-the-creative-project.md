...
The Creative Project is the shift away from the individuality of the Status Project. It represents the genuine component of academic, artistic, or athletic pursuits. It is the element we see in children when we first introduce them to these activities; the part of them that loves it for what it is, without regard for the opinion of others. Oftentimes as this initial passion grows, so too does our Status Project - and thats okay. The Status Project is no better or worse than any other projects.
