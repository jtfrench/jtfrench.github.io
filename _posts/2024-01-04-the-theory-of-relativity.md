...
It is for this reason that we need to classify these dimensions of emotion as *dependent dimensions* because of their imprecise gradient nature and how they all relate to one another.
...
- Have a fun experience with family/friends and then feel lonely a few days later
- Get your heart broken and say you'll never open yourself up emotionally again, but then do a few months/years later

For the first example the comparison point fades away in probably just a few minutes/hours, in the second one its a few days, and in the third one it can be anywhere from a few months to a few years.

![Feeling fade rates](/assets/images/Image 4.jpg)
...
- When reflecting back on a painful romantic experience many years later, you can *remember* how the heartbreak felt, but you don't *feel* those same emotions at nearly the same level as you did during/shortly after.

Upper and lower bounds are defined by *feelings*, and as a result they converge (ie tend towards) the current real-time experience. This is the process of a feeling fading away, however this "fading" is important unto its self.
...
The Upper and Lower Bounds of Experience define the relative direction of an experience, ie does it feel good or bad, but they also define the magnitude, ie *how good* or *how bad* does it feel. The magnitude is dependent on *how far* your current experience is from the upper/lower bound. Magnitudes are a quantity, volume, amount, etc. Using the examples above:
- The discomfort you feel when forgetting someone's name is at its maximum during the moment when your forgetfulness is confronted (ie "It was nice to meet you, uh, sorry, what was your name again?") but then progressively decreases from that moment onwards.
- In the opposite manner, the loneliness you feel after the conclusion of a social event is at its minimum in the exact moment you depart and then progressively grows over time.
- The hurt you feel after a breakup is at its maximum in the moments immediately after the breakup (barring any shock you experience) and gradually, on average, decreases over time.

![Magnitudes](/assets/images/Image 5.jpg)
...
Then as the experience subsides, our real-time experience and the resulting pleasure magnitude begins to drop but our upper bound remains at the same level as the experience is still fresh in our minds. Then over time, depending on the type of experience and how novel it was, the upper bound begins the process of Feeling Fade and decreases.

Another important note is that the same experience can have a decreasing impact on bounds/magnitudes the more often you have the experience. Repeating experiences often have the same direction (ie something that is a positive experience is usually always a positive experience) but they can become less novel.
